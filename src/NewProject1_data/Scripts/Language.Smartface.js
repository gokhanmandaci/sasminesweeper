...
function changeLang(languageCode, doNotify) {
    ...
    case "en":
        lang = {
            ...
            "applicationError": "There has been an unhandled application error, Please check your code again.",
            "delete":"Delete"
        };
        break;
    case "tr":
        lang = {
            ...
            "applicationError": "Beklenmeyen bir hata oluştu, lütfen kodunuzu kontrol ediniz.",
            "delete":"Sil"
        };
        break;
    case "de":
